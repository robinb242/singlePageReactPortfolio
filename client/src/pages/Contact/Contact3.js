  ...
  render(){
    ...
    return(
        ...
        <h3 className='white-color'>Contact Me</h3>
            ...
            <p className='text-faded contact'>Send me a message via the form below or email me <a href="mailto:robin.bertuccelli@gmail.com"> robin.bertuccelli@gmail.com </a> directly.</p>
            <div className="row">
